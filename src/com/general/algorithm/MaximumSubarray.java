...
public class MaximumSubarray {
    ...
    public static int maxSubArray(int[] nums) {
        ...
        for(int i=0; i<length; i++){
            ...
            eachList.add(nums[i]);
            sumList.add(eachList.stream().mapToInt(Integer::intValue).sum());
            // 内层指针
        ...
        Integer[] arra1 = (Integer[])sumList.toArray(new Integer[sumList.size()]);
        Arrays.sort(arra1);
        return arra1[arra1.length-1];
    }
}
